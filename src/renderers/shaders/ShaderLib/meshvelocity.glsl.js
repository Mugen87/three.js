...
void main() {
	...
	clipPositionPrevious = previousProjectionViewMatrix * previousModelMatrix * skinned;

#else

	vec4 mvPosition = modelViewMatrix * vec4( transformed, 1.0 );
	clipPositionCurrent = currentProjectionViewMatrix * modelMatrix * vec4( transformed, 1.0 );
	clipPositionPrevious = previousProjectionViewMatrix * previousModelMatrix * vec4( transformed, 1.0 );
